...
### Modificaciones
- Arreglo de fallos misceláneos

## [0.7] - 2025-11-01
### Añadido
- Modo de juego libre contra 1 jugador
- Lógica de CPU
- Modo de liga
- Modo torneo
...
## [0.6] - 2025-10-21
### Añadido
- Obstáculos y su gestión
- Modificador de Congelar Rival
- Modificador de Controles Invertidos
- Tiros especiales
- Elección de canchas en juego libre

### Modificaciones
- Manejo de sonidos en el menú de pausa

## [0.5] - 2025-08-29
### Añadido
- Restauración de datos tras pausar el juego
- Funcionalidad de gestión de modificadores
- Modificador de Disco Doble

### Modificado
- No se mostrará la barra especial ni la animación de mazos si no se está jugando con tiros especiales
- Ajustes relacionados a la resolución de la pantalla
